package com.despani.x2.core.mybatis.mappers;

import com.despani.x2.core.mybatis.typehandlers.DespPropertyTypeHandler;
...
public interface IPropertiesMapper {
      ...
      @Results(value = {
              ...
              @Result(property = "xtype", column = "xtype", typeHandler = DespPropertyTypeHandler.class),
