 ...
 */
package com.despani.core.utils.cache;


import com.despani.core.utils.DespGlobals;
import com.despani.core.utils.LinkedListNode;
import com.despani.core.utils.StringUtils;
...
public class DefaultCache<K extends Serializable, V extends Serializable> implements Cache<K, V> {
    ...
    private static final boolean allowNull = DespGlobals.getBooleanProperty("cache.allow.null", false);
     ...
     */
    private com.despani.core.utils.LinkedList<K> lastAccessedList;

    /**
     * Linked list to maintain time that cache objects were initially added
     * to the cache, most recently added to oldest added.
     */
    private com.despani.core.utils.LinkedList<K> ageList;
    ...
    DefaultCache(final String name, final long maxSize, final long maxLifetime) {
        ...
        lastAccessedList = new com.despani.core.utils.LinkedList<>();
        ageList = new com.despani.core.utils.LinkedList<>();
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        ...
        synchronized (this) {
            return map.entrySet().stream()
                .collect(Collectors.toMap(Map.Entry::getKey, entry -> entry.getValue().object))
                .entrySet();
        }
    }
    ...
    private static class CacheObject<V> {
         ...
         * moved to the front.
         */
        com.despani.core.utils.LinkedListNode<?> lastAccessedListNode;
         ...
         */
        com.despani.core.utils.LinkedListNode<?> ageListNode;
